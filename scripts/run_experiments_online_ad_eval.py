...
def get_experiment_config(mode, current_dir):
    ...
    """
    if mode == 'own_pv':
        logging.info("Selected Mode: 1. Evaluation own methods on spectral datasets (Original and BV4 Benchmarks).")
        return {
        ...
        logging.info("Selected Mode: 2. Evaluation own methods on spectral datasets (BV5 Benchmark).")
        return {
            "param_grid": BEST_GRID_PV_DS_FOR_OWN_EVAL,
        ...
        logging.info("Selected Mode: 3. Evaluation SOTA methods on spectral datasets (Original and BV4 Benchmarks).")
        return {
        ...
        logging.info("Selected Mode: 4. Evaluation SOTA methods on spectral datasets (BV5 Benchmark).")
        return {
            "param_grid": BEST_GRID_PV_DS_FOR_SOTA_EVAL,
...
def main():
    ...
    modes = [
        'own_pv',             # 1. Own method evaluation on PV Datasets (BV3, BV4)
        'own_pv_bv5_gtv2',    # 2. Own method evaluation on PV Datasets (BV5 GTV2)
        'sota_pv',            # 3. SOTA method evaluation on PV Datasets (BV3 and BV4)
        'sota_pv_bv5_gtv2',   # 4. SOTA method evaluation on PV Datasets (BV5 GTV2)
