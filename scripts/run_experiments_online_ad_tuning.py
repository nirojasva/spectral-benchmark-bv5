...
def get_experiment_config(mode, current_dir):
    ...
    """
    if mode == 'own_pds':
        logging.info("Selected Mode: 1. Tuning own methods on Multivariate Datasets.")
        return {
        ...
        logging.info("Selected Mode: 2. Tuning SOTA methods on Multivariate Datasets.")
        return {
        ...
        logging.info("Selected Mode: 3. Tuning own methods on Spectral Datasets.")
        return {
            "param_grid": PARAM_GRID_OWN_TUNING,
        ...
        logging.info("Selected Mode: 4. Tuning SOTA methods on Spectral Datasets.")
        return {
            "param_grid": PARAM_GRID_SOTA_TUNING,
...
def main():
    ...
    modes = [
        ...
        'own_pv',     # 3. Own method tuning on spectral Datasets
        'sota_pv',    # 4. SOTA method tuning on spectral Datasets
